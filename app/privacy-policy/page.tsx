        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-8 text-foreground">
              ...
              <section>
                ...
                <h3 className="text-lg font-semibold mt-4 mb-2">2.1 Información de Registro</h3>
                ...
                <h3 className="text-lg font-semibold mt-4 mb-2">2.2 Información de la Empresa</h3>
                <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <h3 className="text-lg font-semibold mt-4 mb-2">2.3 Información de Uso</h3>
                <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4">11. Privacidad de Menores</h2>
                <p className="text-muted-foreground leading-relaxed">
