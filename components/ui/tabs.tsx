...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center whitespace-nowrap rounded-lg px-4 h-12 text-sm transition-all text-muted-foreground border shadow-xs hover:text-blue-600 hover:bg-blue-50 hover:border-blue-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:text-white data-[state=active]:border-transparent data-[state=active]:shadow-sm font-medium-heading",
      "border-[var(--color-gray)]",
      "data-[state=active]:bg-gradient-to-br data-[state=active]:from-[var(--gradient-top-left)] data-[state=active]:via-[var(--gradient-top-right)] data-[state=active]:to-[var(--gradient-bottom-right)]",
      className
    )}
    {...props}
  />
